...
//  TMS_Geom::GetInstance().Scale(positionV[0], positionV[1], positionV[2]);
  ...
  double UV_y = -3864 + 0.5 * TMS_Manager::GetInstance().Get_Reco_TRACKMATCH_TiltAngle() * std::abs(UHit.GetNotZ() - VHit.GetNotZ()); //-1350
...
//  TMS_Geom::GetInstance().Scale(positionOther[0], positionOther[1], positionOther[2]);
  ...
  OneHit.SetRecoY(-3864 + 0.5 * TMS_Manager::GetInstance().Get_Reco_TRACKMATCH_TiltAngle() * std::abs(OneHit.GetNotZ() - OtherHit.GetNotZ()));  //positionOne[1], positionOther[1] //0.5 * (OneHit.GetY() + OtherHit.GetY())//-1350
