...
class TMS_Manager {
  ...
  public:
    ...
    double Get_Reco_HOUGH_ContainmentHalfWidthX() { return _RECO_HOUGH_ContainmentHalfWidthX; };
    double Get_Reco_HOUGH_ContainmentHalfWidthY() { return _RECO_HOUGH_ContainmentHalfWidthY; };
    ...
    double Get_Reco_EXTRAPOLATION_ContainmentWidthScaleX() { return _RECO_EXTRAPOLATION_ContainmentWidthScaleX; };
    double Get_Reco_EXTRAPOLATION_ContainmentWidthScaleY() { return _RECO_EXTRAPOLATION_ContainmentWidthScaleY; };
  ...
  private:
    ...
    double _RECO_HOUGH_ContainmentHalfWidthX;
    double _RECO_HOUGH_ContainmentHalfWidthY;
    ...
    double _RECO_EXTRAPOLATION_ContainmentWidthScaleX;
    double _RECO_EXTRAPOLATION_ContainmentWidthScaleY;
