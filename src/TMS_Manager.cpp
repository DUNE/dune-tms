...
TMS_Manager::TMS_Manager() {
  ...
  _RECO_EXTRAPOLATION_XBarTransverseScale = toml::find<double>(data, "Recon", "Extrapolation", "XBarTransverseScale");
  ...
  _RECO_TRACKMATCH_XStereoInTrackGapScale = toml::find<double>(data, "Recon", "TrackMatch3D", "XStereoInTrackGapScale");
  _RECO_TRACKMATCH_XStereoEndpointGapScale = toml::find<double>(data, "Recon", "TrackMatch3D", "XStereoEndpointGapScale");
  _RECO_TRACKMATCH_XStereoZPaddingMm = toml::find<double>(data, "Recon", "TrackMatch3D", "XStereoZPaddingMm");
