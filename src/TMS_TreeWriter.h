...
class TMS_TreeWriter {
  ...
  public:
    ...
    float RecoTrackKalmanPos[__TMS_MAX_TRACKS__][__TMS_MAX_LINE_HITS__][5];
    float RecoTrackKalmanUpdateVec[__TMS_MAX_TRACKS__][__TMS_MAX_LINE_HITS__][5];
    float RecoTrackKalmanMeasurementVec[__TMS_MAX_TRACKS__][__TMS_MAX_LINE_HITS__][5];
    ...
    float RecoTrackLength_Kalman[__TMS_MAX_TRACKS__];
