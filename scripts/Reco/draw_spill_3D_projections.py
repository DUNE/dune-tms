        ...
        for i in range(n_events):
            ...
            if only_true_tms_muons:
                for idx, pdg in enumerate(true_event.PDG):
                    ...
                    x_z.text(3.6, -2.5, f'Muon KE at LAr: {muon_ke_lar:.2f} GeV', fontsize = 12, fontweight = 'bold', color = orange_cbf)
                    x_z.text(3.6, -2.75, f'Muon KE entering TMS: {muon_ke_tms_start:.2f} GeV', fontsize = 12, fontweight = 'bold', color = orange_cbf)
