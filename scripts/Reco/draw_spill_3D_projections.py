    ...
    for current_spill_number in range(max_n_spills):
        for i in range(n_events):
            ...
            for j in range(nTracks):
                ...
                ### Set TMS name
                x_y.text(-tms_outer_steel, tms_top_hybrid, 'TMS', fontsize = 14, fontweight = 'bold', color = orange_cbf, alpha = 0.8)
                z_y.text(tms_start + 0.024, tms_top_hybrid, 'TMS', fontsize = 14, fontweight = 'bold', color = orange_cbf, alpha = 0.8)
                x_z.text(tms_start + 0.024, tms_outer_steel + 0.06, 'TMS', fontsize = 14, fontweight = 'bold', color = orange_cbf, alpha = 0.8)
