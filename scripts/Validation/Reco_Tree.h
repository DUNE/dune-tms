...
// found on file:
// /pnfs/dune/persistent/users/kleykamp/tmsreco_combined_files/2024-04-19_bfield_0p0T.tmsreco.root
//////////////////////////////////////////////////////////
...
#define __TMS_MAX_TRACKS__ 100
  ...
  Float_t TrackHitPos[__TMS_MAX_TRACKS__][200][4];   //[nTracks]
  ...
  Int_t Charge_Kalman[__TMS_MAX_TRACKS__];           //[nTracks]
  Float_t Chi2[__TMS_MAX_TRACKS__];                  //[nTracks]
  Float_t Chi2_plus[__TMS_MAX_TRACKS__];             //[nTracks]
  Float_t Chi2_minus[__TMS_MAX_TRACKS__];            //[nTracks]
  ...
  TBranch *b_Length_3D;                            //!
  TBranch *b_Charge;                               //!
  TBranch *b_Charge_Kalman;                        //!
  TBranch *b_Chi2;                                 //!
  TBranch *b_Chi2_plus;                            //!
  TBranch *b_Chi2_minus;                           //!
...
Reco_Tree::Reco_Tree(TTree *tree) : fChain(0) {
  ...
  if (tree == 0) {
    TFile *f = (TFile *)gROOT->GetListOfFiles()->FindObject(
        "/pnfs/dune/persistent/users/kleykamp/tmsreco_combined_files/"
        "2024-04-19_bfield_0p0T.tmsreco.root");
    if (!f || !f->IsOpen()) {
      f = new TFile(
          "/pnfs/dune/persistent/users/kleykamp/tmsreco_combined_files/"
          "2024-04-19_bfield_0p0T.tmsreco.root");
...
void Reco_Tree::Init(TTree *tree) {
  ...
  // if (HasBranch("Direction")) fChain->SetBranchAddress("Direction",
  // Direction, &b_Direction); else fChain->SetBranchAddress("StartDirection",
  ...
  fChain->SetBranchAddress("Charge_Kalman", Charge_Kalman, &b_Charge_Kalman);
  fChain->SetBranchAddress("Chi2", Chi2, &b_Chi2);
  fChain->SetBranchAddress("Chi2_plus", Chi2_plus, &b_Chi2_plus);
  fChain->SetBranchAddress("Chi2_minus", Chi2_minus, &b_Chi2_minus);
  fChain->SetBranchAddress("TrackHitEnergies", TrackHitEnergies,
                           &b_RecoTrackHitEnergies);
  fChain->SetBranchAddress("TimeSliceStartTime", &TimeSliceStartTime,
                           &b_TimeSliceStartTime);
  fChain->SetBranchAddress("TimeSliceEndTime", &TimeSliceEndTime,
                           &b_TimeSliceEndTime);
  fChain->SetBranchAddress("RecoTrackKalmanFirstPlaneBarView",
                           RecoTrackKalmanFirstPlaneBarView,
                           &b_RecoTrackKalmanFirstPlaneBarView);
  fChain->SetBranchAddress("RecoTrackKalmanLastPlaneBarView",
                           RecoTrackKalmanLastPlaneBarView,
                           &b_RecoTrackKalmanLastPlaneBarView);
  fChain->SetBranchAddress("RecoTrackKalmanPlaneBarView",
                           RecoTrackKalmanPlaneBarView,
                           &b_RecoTrackKalmanPlaneBarView);
  fChain->SetBranchAddress("RecoTrackKalmanFirstPlaneBarViewTrue",
                           RecoTrackKalmanFirstPlaneBarViewTrue,
                           &b_RecoTrackKalmanFirstPlaneBarViewTrue);
  fChain->SetBranchAddress("RecoTrackKalmanLastPlaneBarViewTrue",
                           RecoTrackKalmanLastPlaneBarViewTrue,
                           &b_RecoTrackKalmanLastPlaneBarViewTrue);
  fChain->SetBranchAddress("RecoTrackKalmanPlaneBarViewTrue",
                           RecoTrackKalmanPlaneBarViewTrue,
                           &b_RecoTrackKalmanPlaneBarViewTrue);
  Notify();
}
