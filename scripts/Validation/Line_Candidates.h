...
void Line_Candidates::Init(TTree *tree) {
  ...
  fChain->SetBranchAddress("Slope_DownstreamU", Slope_DownstreamU,
                           &b_Slope_DownstreamU);
  fChain->SetBranchAddress("Intercept_DownstreamU", Intercept_DownstreamU,
                           &b_Intercept_DownstreamU);
  fChain->SetBranchAddress("Slope_UpstreamU", Slope_UpstreamU,
                           &b_Slope_UpstreamU);
  fChain->SetBranchAddress("Intercept_UpstreamU", Intercept_UpstreamU,
                           &b_Intercept_UpstreamU);
  fChain->SetBranchAddress("SlopeV", SlopeV, &b_SlopeV);
  fChain->SetBranchAddress("InterceptV", InterceptV, &b_InterceptV);
  fChain->SetBranchAddress("Slope_DownstreamV", Slope_DownstreamV,
                           &b_Slope_DownstreamV);
  fChain->SetBranchAddress("Intercept_DownstreamV", Intercept_DownstreamV,
                           &b_Intercept_DownstreamV);
  fChain->SetBranchAddress("Slope_UpstreamV", Slope_UpstreamV,
                           &b_Slope_UpstreamV);
  fChain->SetBranchAddress("Intercept_UpstreamV", Intercept_UpstreamV,
                           &b_Intercept_UpstreamV);
  fChain->SetBranchAddress("SlopeX", &SlopeX, &b_SlopeX);
  fChain->SetBranchAddress("InterceptX", &InterceptX, &b_InterceptX);
  fChain->SetBranchAddress("Slope_DownstreamX", &Slope_DownstreamX,
                           &b_Slope_DownstreamX);
  fChain->SetBranchAddress("Intercept_DownstreamX", &Intercept_DownstreamX,
                           &b_Intercept_DownstreamX);
  fChain->SetBranchAddress("Slope_UpstreamX", &Slope_UpstreamX,
                           &b_Slope_UpstreamX);
  fChain->SetBranchAddress("Intercept_UpstreamX", &Intercept_UpstreamX,
                           &b_Intercept_UpstreamX);
  fChain->SetBranchAddress("SlopeY", SlopeY, &b_SlopeY);
  fChain->SetBranchAddress("InterceptY", InterceptY, &b_InterceptY);
  fChain->SetBranchAddress("Slope_DownstreamY", Slope_DownstreamY,
                           &b_Slope_DownstreamY);
  fChain->SetBranchAddress("Intercept_DownstreamY", Intercept_DownstreamY,
                           &b_Intercept_DownstreamY);
  fChain->SetBranchAddress("Slope_UpstreamY", Slope_UpstreamY,
                           &b_Slope_UpstreamY);
  fChain->SetBranchAddress("Intercept_UpstreamY", Intercept_UpstreamY,
                           &b_Intercept_UpstreamY);
  ...
  fChain->SetBranchAddress("DirectionZY_Upstream", DirectionZY_Upstream,
                           &b_DirectionZY_Upstream);
  fChain->SetBranchAddress("DirectionXY_Upstream", DirectionXY_Upstream,
                           &b_DirectionXY_Upstream);
  fChain->SetBranchAddress("DirectionZY_Downstream", DirectionZY_Downstream,
                           &b_DirectionZY_Downstream);
  fChain->SetBranchAddress("DirectionXY_Downstream", DirectionXY_Downstream,
                           &b_DirectionXY_Downstream);
  ...
  fChain->SetBranchAddress("FirstHoughHitTimeY", FirstHoughHitTimeY,
                           &b_FirstHoughHitTimeY);
  fChain->SetBranchAddress("LastHoughHitTimeY", LastHoughHitTimeY,
                           &b_LastHoughHitTimeY);
  fChain->SetBranchAddress("HoughEarliestHitTimeY", HoughEarliestHitTimeY,
                           &b_HoughEarliestHitTimeY);
  fChain->SetBranchAddress("HoughLatestHitTimeY", HoughLatestHitTimeY,
                           &b_HoughLatestHitTimeY);
  fChain->SetBranchAddress("FirstHoughPlaneY", FirstHoughPlaneY,
                           &b_FirstHoughPlaneY);
  fChain->SetBranchAddress("LastHoughPlaneY", LastHoughPlaneY,
                           &b_LastHoughPlaneY);
  ...
  fChain->SetBranchAddress("TotalTrackEnergyY", TotalTrackEnergyY,
                           &b_TotalTrackEnergyY);
  fChain->SetBranchAddress("TrackStoppingY", TrackStoppingY,
                           &b_TrackStoppingY);
  fChain->SetBranchAddress("nHitsInTrackY", nHitsInTrackY, &b_nHitsInTrackY);
  fChain->SetBranchAddress("TrackHitEnergyY", TrackHitEnergyY,
                           &b_TrackHitEnergyY);
  ...
  fChain->SetBranchAddress("ClusterPosMeanY", ClusterPosMeanY,
                           &b_ClusterPosMeanY);
  fChain->SetBranchAddress("ClusterPosStdDevY", ClusterPosStdDevY,
                           &b_ClusterPosStdDevY);
  fChain->SetBranchAddress("nHitsInClusterY", nHitsInClusterY,
                           &b_nHitsInClusterY);
  fChain->SetBranchAddress("ClusterHitPosY", ClusterHitPosY,
                           &b_ClusterHitPosY);
  fChain->SetBranchAddress("ClusterHitEnergyY", ClusterHitEnergyY,
                           &b_ClusterHitEnergyY);
  fChain->SetBranchAddress("ClusterHitTimeY", ClusterHitTimeY,
                           &b_ClusterHitTimeY);
  fChain->SetBranchAddress("ClusterHitSliceY", ClusterHitSliceY,
                           &b_ClusterHitSliceY);
  ...
  fChain->SetBranchAddress("DirectionZU_Downstream", DirectionZU_Downstream,
  &b_DirectionZU_Downstream); fChain->SetBranchAddress("DirectionXU_Downstream",
  DirectionXU_Downstream, &b_DirectionXU_Downstream);
  fChain->SetBranchAddress("DirectionZU_Upstream", DirectionZU_Upstream,
  &b_DirectionZU_Upstream); fChain->SetBranchAddress("DirectionXU_Upstream",
  DirectionXU_Upstream, &b_DirectionXU_Upstream);
  fChain->SetBranchAddress("DirectionZV_Downstream", DirectionZV_Downstream,
  &b_DirectionZV_Downstream); fChain->SetBranchAddress("DirectionXV_Downstream",
  DirectionXV_Downstream, &b_DirectionXV_Downstream);
  fChain->SetBranchAddress("DirectionZV_Upstream", DirectionZV_Upstream,
  &b_DirectionZV_Upstream); fChain->SetBranchAddress("DirectionXV_Upstream",
  DirectionXV_Upstream, &b_DirectionXV_Upstream);
  fChain->SetBranchAddress("DirectionZX_Downstream", &DirectionZX_Downstream,
  &b_DirectionZX_Downstream); fChain->SetBranchAddress("DirectionYX_Downstream",
  &DirectionYX_Downstream, &b_DirectionYX_Downstream);
  fChain->SetBranchAddress("DirectionZX_Upstream", &DirectionZX_Upstream,
  &b_DirectionZX_Upstream); fChain->SetBranchAddress("DirectionYX_Upstream",
  &DirectionYX_Upstream, &b_DirectionYX_Upstream);
  ...
  fChain->SetBranchAddress("FirstHoughHitX", &FirstHoughHitX,
  &b_FirstHoughHitX); fChain->SetBranchAddress("LastHoughHitU", LastHoughHitU,
  &b_LastHoughHitU); fChain->SetBranchAddress("LastHoughHitV", LastHoughHitV,
  &b_LastHoughHitV); fChain->SetBranchAddress("LastHoughHitX", &LastHoughHitX,
  &b_LastHoughHitX); fChain->SetBranchAddress("FirstHoughHitTimeU",
  FirstHoughHitTimeU, &b_FirstHoughHitTimeU);
  fChain->SetBranchAddress("FirstHoughHitTimeV", FirstHoughHitTimeV,
  &b_FirstHoughHitTimeV); fChain->SetBranchAddress("FirstHoughHitTimeX",
  &FirstHoughHitTimeX, &b_FirstHoughHitTimeX);
  fChain->SetBranchAddress("LastHoughHitTimeU", LastHoughHitTimeU,
  &b_LastHoughHitTimeU); fChain->SetBranchAddress("LastHoughHitTimeV",
  LastHoughHitTimeV, &b_LastHoughHitTimeV);
  fChain->SetBranchAddress("LastHoughHitTImeX", &LastHoughHitTImeX,
  &b_LastHoughHitTImeX); fChain->SetBranchAddress("HoughEarliestHitTimeU",
  HoughEarliestHitTimeU, &b_HoughEarliestHitTimeU);
  fChain->SetBranchAddress("HoughEarliestHitTimeV", HoughEarliestHitTimeV,
  &b_HoughEarliestHitTimeV); fChain->SetBranchAddress("HoughEarliestHitTimeX",
  &HoughEarliestHitTimeX, &b_HoughEarliestHitTimeX);
  fChain->SetBranchAddress("HoughLatestHitTimeU", HoughLatestHitTimeU,
  &b_HoughLatestHitTimeU); fChain->SetBranchAddress("HoughLatestHitTimeV",
  HoughLatestHitTimeV, &b_HoughLatestHitTimeV);
  fChain->SetBranchAddress("HoughLatestHitTimeX", &HoughLatestHitTimeX,
  &b_HoughLatestHitTimeX); fChain->SetBranchAddress("FirstHoughPlaneU",
  FirstHoughPlaneU, &b_FirstHoughPlaneU);
  fChain->SetBranchAddress("FirstHoughPlaneV", FirstHoughPlaneV,
  &b_FirstHoughPlaneV); fChain->SetBranchAddress("FirstHoughPlaneX",
  &FirstHoughPlaneX, &b_FirstHoughPlaneX);
  fChain->SetBranchAddress("LastHoughPlaneU", LastHoughPlaneU,
  &b_LastHoughPlaneU); fChain->SetBranchAddress("LastHoughPlaneV",
  LastHoughPlaneV, &b_LastHoughPlaneV);
  fChain->SetBranchAddress("LastHoughPlaneX", &LastHoughPlaneX,
  &b_LastHoughPlaneX);*/
  ...
  fChain->SetBranchAddress("TotalTrackEnergyU", TotalTrackEnergyU,
                           &b_TotalTrackEnergyU);
  fChain->SetBranchAddress("TotalTrackEnergyV", TotalTrackEnergyV,
                           &b_TotalTrackEnergyV);
  fChain->SetBranchAddress("TotalTrackEnergyX", &TotalTrackEnergyX,
                           &b_TotalTrackEnergyX);
  ...
  fChain->SetBranchAddress("TrackStoppingX", &TrackStoppingX,
                           &b_TrackStoppingX);
  ...
  fChain->SetBranchAddress("TrackHitEnergyU", TrackHitEnergyU,
                           &b_TrackHitEnergyU);
  fChain->SetBranchAddress("TrackHitEnergyV", TrackHitEnergyV,
                           &b_TrackHitEnergyV);
  fChain->SetBranchAddress("TrackHitEnergyX", TrackHitEnergyX,
                           &b_TrackHitEnergyX);
  ...
  fChain->SetBranchAddress("ClusterEnergyX", &ClusterEnergyX,
  &b_ClusterEnergyX); fChain->SetBranchAddress("ClusterTimeU", ClusterTimeU,
  &b_ClusterTimeU); fChain->SetBranchAddress("ClusterTimeV", ClusterTimeV,
  &b_ClusterTimeV); fChain->SetBranchAddress("ClusterTimeX", &ClusterTimeX,
  &b_ClusterTimeX); fChain->SetBranchAddress("ClusterPosMeanU", ClusterPosMeanU,
  &b_ClusterPosMeanU); fChain->SetBranchAddress("ClusterPosMeanV",
  ClusterPosMeanV, &b_ClusterPosMeanV);
  fChain->SetBranchAddress("ClusterPosMeanX", ClusterPosMeanX,
  &b_ClusterPosMeanX); fChain->SetBranchAddress("ClusterPosStdDevU",
  ClusterPosStdDevU, &b_ClusterPosStdDevU);
  fChain->SetBranchAddress("ClusterPosStdDevV", ClusterPosStdDevV,
  &b_ClusterPosStdDevV); fChain->SetBranchAddress("ClusterPosStdDevX",
  ClusterPosStdDevX, &b_ClusterPosStdDevX);
  fChain->SetBranchAddress("nHitsInClusterU", nHitsInClusterU,
  &b_nHitsInClusterU); fChain->SetBranchAddress("nHitsInClusterV",
  nHitsInClusterV, &b_nHitsInClusterV);
  fChain->SetBranchAddress("nHitsInClusterX", &nHitsInClusterX,
  &b_nHitsInClusterX); fChain->SetBranchAddress("ClusterHitPosU",
  ClusterHitPosU, &b_ClusterHitPosU); fChain->SetBranchAddress("ClusterHitPosV",
  ClusterHitPosV, &b_ClusterHitPosV); fChain->SetBranchAddress("ClusterHitPosX",
  ClusterHitPosX, &b_ClusterHitPosX);
  fChain->SetBranchAddress("ClusterHitEnergyU", ClusterHitEnergyU,
  &b_ClusterHitEnergyU); fChain->SetBranchAddress("ClusterHitEnergyV",
  ClusterHitEnergyV, &b_ClusterHitEnergyV);
  fChain->SetBranchAddress("ClusterHitEnergyX", ClusterHitEnergyX,
  &b_ClusterHitEnergyX); fChain->SetBranchAddress("ClusterHitTimeU",
  ClusterHitTimeU, &b_ClusterHitTimeU);
  fChain->SetBranchAddress("ClusterHitTimeV", ClusterHitTimeV,
  &b_ClusterHitTimeV); fChain->SetBranchAddress("ClusterHitTimeX",
  ClusterHitTimeX, &b_ClusterHitTimeX);
  fChain->SetBranchAddress("ClusterHitSliceU", ClusterHitSliceU,
  &b_ClusterHitSliceU); fChain->SetBranchAddress("ClusterHitSliceV",
  ClusterHitSliceV, &b_ClusterHitSliceV);
  fChain->SetBranchAddress("ClusterHitSliceX", ClusterHitSliceX,
  &b_ClusterHitSliceX); */
