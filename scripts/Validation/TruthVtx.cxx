{
  ...
  if (on_new_spill) {
    GetHist("basic__truth_vtx__TrueVtxN", "TrueVtxN", "n0-120", "#N Spills")
        ->Fill(truth_spill.TrueVtxN);
    const int n_true_vertices =
        std::max(0, std::min<int>(truth_spill.TrueVtxN, Truth_Spill::kMaxTrueVertices));
    for (int ivtx = 0; ivtx < n_true_vertices; ivtx++) {
      // Position info
      GetHist("basic__truth_vtx__TrueVtxX", "TrueVtxX", "X", "#N Vertices")
          ->Fill(truth_spill.TrueVtxX[ivtx] * CM);
      GetHist("basic__truth_vtx__TrueVtxY", "TrueVtxY", "Y_full", "#N Vertices")
          ->Fill(truth_spill.TrueVtxY[ivtx] * CM);
      GetHist("basic__truth_vtx__TrueVtxZ", "TrueVtxZ", "Z_full", "#N Vertices")
          ->Fill(truth_spill.TrueVtxZ[ivtx] * CM);
      GetHist("basic__truth_vtx__TrueVtxT", "TrueVtxT", "T", "#N Vertices")
          ->Fill(truth_spill.TrueVtxT[ivtx]);
      GetHist("basic__truth_vtx__TrueVtxXY", "TrueVtx X vs Y", "X", "Y_full")
          ->Fill(truth_spill.TrueVtxX[ivtx] * CM, truth_spill.TrueVtxY[ivtx] * CM);
      GetHist("basic__truth_vtx__TrueVtxYZ", "TrueVtx Y vs Z", "Z_full",
              "Y_full")
          ->Fill(truth_spill.TrueVtxZ[ivtx] * CM, truth_spill.TrueVtxY[ivtx] * CM);
      GetHist("basic__truth_vtx__TrueVtxXZ", "TrueVtx X vs Z", "Z_full",
              "X")
          ->Fill(truth_spill.TrueVtxZ[ivtx] * CM, truth_spill.TrueVtxX[ivtx] * CM);

      GetHist("basic__truth_vtx__TrueVtxPz", "TrueVtxPz", "PNuZ", "#N Vertices")
          ->Fill(truth_spill.TrueVtxPz[ivtx] * GEV);
      double P = TVector3(truth_spill.TrueVtxPx[ivtx], truth_spill.TrueVtxPy[ivtx],
                          truth_spill.TrueVtxPz[ivtx])
                     .Mag() *
                 GEV;
      GetHist("basic__truth_vtx__TrueVtxP", "TrueVtxP", "PNu", "#N Vertices")
          ->Fill(P);
      GetHist("basic__truth_vtx__TrueVtxE", "TrueVtxE", "ENu", "#N Vertices")
          ->Fill(truth_spill.TrueVtxE[ivtx] * GEV);

      GetHist("basic__truth_vtx__TrueVtxHadronicELarShell",
              "TrueVtxHadronicELarShell", "GenericHadE", "#N Vertices")
          ->Fill(truth_spill.TrueVtxHadronicELarShell[ivtx]);
      GetHist("basic__truth_vtx__TrueVtxHadronicELarShell",
              "TrueVtxHadronicELAr", "GenericHadE", "#N Vertices")
          ->Fill(truth_spill.TrueVtxHadronicELAr[ivtx]);
      ...
      if (truth_spill.TrueVtxShellEnergyCut[ivtx]) {
      ...
      if (truth_spill.TrueVtxNDPhysicsCut[ivtx]) {
