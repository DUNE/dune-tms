...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Int_t           VertexID[96];   //[nTrueParticles]
   Int_t           Parent[96];   //[nTrueParticles]
   Int_t           TrackId[96];   //[nTrueParticles]
   Int_t           PDG[96];   //[nTrueParticles]
   Bool_t          IsPrimary[96];   //[nTrueParticles]
   Float_t         TrueVisibleEnergy[96];   //[nTrueParticles]
   Float_t         TruePathLength[96];   //[nTrueParticles]
   Float_t         TruePathLengthIgnoreY[96];   //[nTrueParticles]
   Float_t         TruePathLengthInTMS[96];   //[nTrueParticles]
   Float_t         TruePathLengthInTMSIgnoreY[96];   //[nTrueParticles]
   Bool_t          InteractionTMSFiducial;
   Bool_t          InteractionTMSFirstTwoModules;
   Bool_t          InteractionTMSThin;
   Bool_t          InteractionLArFiducial;
   Bool_t          TMSFiducialStart[96];   //[nTrueParticles]
   Bool_t          TMSFiducialTouch[96];   //[nTrueParticles]
   Bool_t          TMSFiducialEnd[96];   //[nTrueParticles]
   Bool_t          LArFiducialStart[96];   //[nTrueParticles]
   Bool_t          LArFiducialTouch[96];   //[nTrueParticles]
   Bool_t          LArFiducialEnd[96];   //[nTrueParticles]
   Float_t         BirthMomentum[96][4];   //[nTrueParticles]
   Float_t         BirthPosition[96][4];   //[nTrueParticles]
   Float_t         DeathMomentum[96][4];   //[nTrueParticles]
   Float_t         DeathPosition[96][4];   //[nTrueParticles]
   Float_t         MomentumLArStart[96][4];   //[nTrueParticles]
   Float_t         PositionLArStart[96][4];   //[nTrueParticles]
   Float_t         MomentumLArEnd[96][4];   //[nTrueParticles]
   Float_t         PositionLArEnd[96][4];   //[nTrueParticles]
   Float_t         MomentumTMSStart[96][4];   //[nTrueParticles]
   Float_t         PositionTMSStart[96][4];   //[nTrueParticles]
   Float_t         MomentumTMSFirstTwoModulesEnd[96][4];   //[nTrueParticles]
   Float_t         PositionTMSFirstTwoModulesEnd[96][4];   //[nTrueParticles]
   Float_t         MomentumTMSThinEnd[96][4];   //[nTrueParticles]
   Float_t         PositionTMSThinEnd[96][4];   //[nTrueParticles]
   Float_t         MomentumTMSEnd[96][4];   //[nTrueParticles]
   Float_t         PositionTMSEnd[96][4];   //[nTrueParticles]
   Float_t         MomentumZIsLArEnd[96][4];   //[nTrueParticles]
   Float_t         PositionZIsLArEnd[96][4];   //[nTrueParticles]
   Float_t         MomentumZIsTMSStart[96][4];   //[nTrueParticles]
   Float_t         PositionZIsTMSStart[96][4];   //[nTrueParticles]
   Float_t         MomentumZIsTMSEnd[96][4];   //[nTrueParticles]
   Float_t         PositionZIsTMSEnd[96][4];   //[nTrueParticles]
   Int_t           nParticles;
   Int_t           LeptonPDG;
   Float_t         LeptonP4[4];
   Float_t         LeptonX4[4];
   ...
   Int_t           RecoTrackN;
   Float_t         RecoTrackTrueVisibleEnergy[8];   //[RecoTrackN]
   Int_t           RecoTrackPrimaryParticleIndex[8];   //[RecoTrackN]
   Float_t         RecoTrackPrimaryParticleTrueVisibleEnergy[8];   //[RecoTrackN]
   Int_t           RecoTrackSecondaryParticleIndex[8];   //[RecoTrackN]
   Float_t         RecoTrackSecondaryParticleTrueVisibleEnergy[8];   //[RecoTrackN]
   Float_t         RecoTrackPrimaryParticleTrueMomentumTrackStart[8][4];   //[RecoTrackN]
   Float_t         RecoTrackPrimaryParticleTruePositionTrackStart[8][4];   //[RecoTrackN]
   Float_t         RecoTrackPrimaryParticleTrueMomentumTrackEnd[8][4];   //[RecoTrackN]
   Float_t         RecoTrackPrimaryParticleTruePositionTrackEnd[8][4];   //[RecoTrackN]
   Int_t           RecoTrackNHits[8];   //[RecoTrackN]
   Float_t         RecoTrackTrueHitPosition[8][300][4];   //[RecoTrackN]
   Float_t         RecoTrackPrimaryParticleTrueTrackLengthAsMeasured[8];   //[RecoTrackN]
   Float_t         RecoTrackPrimaryParticleTrueTrackLengthAsMeasuredIgnoreY[8];   //[RecoTrackN]
   Float_t         RecoTrackPrimaryParticleTrueTrackLengthRecoStart[8];   //[RecoTrackN]
   Float_t         RecoTrackPrimaryParticleTrueTrackLengthRecoStartIgnoreY[8];   //[RecoTrackN]
   Float_t         RecoTrackPrimaryParticleTrueTrackLengthInTMSIgnoreY[8];   //[RecoTrackN]
   Int_t           RecoTrackPrimaryParticlePDG[8];   //[RecoTrackN]
   Bool_t          RecoTrackPrimaryParticleIsPrimary[8];   //[RecoTrackN]
   Float_t         RecoTrackPrimaryParticleTrueMomentum[8][4];   //[RecoTrackN]
   Float_t         RecoTrackPrimaryParticleTruePositionStart[8][4];   //[RecoTrackN]
   Float_t         RecoTrackPrimaryParticleTruePositionEnd[8][4];   //[RecoTrackN]
   Float_t         RecoTrackPrimaryParticleTrueTrackLength[8];   //[RecoTrackN]
   Float_t         RecoTrackPrimaryParticleTrueTrackLengthIgnoreY[8];   //[RecoTrackN]
   Float_t         RecoTrackPrimaryParticleTrueTrackLengthInTMS[8];   //[RecoTrackN]
   Float_t         RecoTrackPrimaryParticleTrueMomentumEnteringTMS[8][4];   //[RecoTrackN]
   Float_t         RecoTrackPrimaryParticleTrueMomentumLeavingTMS[8][4];   //[RecoTrackN]
   Bool_t          RecoTrackPrimaryParticleTMSFiducialStart[8];   //[RecoTrackN]
   Bool_t          RecoTrackPrimaryParticleTMSFiducialTouch[8];   //[RecoTrackN]
   Bool_t          RecoTrackPrimaryParticleTMSFiducialEnd[8];   //[RecoTrackN]
   Bool_t          RecoTrackPrimaryParticleLArFiducialStart[8];   //[RecoTrackN]
   Bool_t          RecoTrackPrimaryParticleLArFiducialTouch[8];   //[RecoTrackN]
   Bool_t          RecoTrackPrimaryParticleLArFiducialEnd[8];   //[RecoTrackN]
   Int_t           RecoTrackSecondaryParticlePDG[8];   //[RecoTrackN]
   Bool_t          RecoTrackSecondaryParticleIsPrimary[8];   //[RecoTrackN]
   Float_t         RecoTrackSecondaryParticleTrueMomentum[8][4];   //[RecoTrackN]
   Float_t         RecoTrackSecondaryParticleTruePositionStart[8][4];   //[RecoTrackN]
   Float_t         RecoTrackSecondaryParticleTruePositionEnd[8][4];   //[RecoTrackN]
