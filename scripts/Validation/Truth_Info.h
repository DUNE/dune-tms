...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Int_t           RecoTrackN;
   Float_t         RecoTrackTrueVisibleEnergy[100];   //[RecoTrackN]
   Int_t           RecoTrackPrimaryParticleIndex[100];   //[RecoTrackN]
   Float_t         RecoTrackPrimaryParticleTrueVisibleEnergy[100];   //[RecoTrackN]
   Int_t           RecoTrackSecondaryParticleIndex[100];   //[RecoTrackN]
   Float_t         RecoTrackSecondaryParticleTrueVisibleEnergy[100];   //[RecoTrackN]
   Float_t         RecoTrackPrimaryParticleTrueMomentumTrackStart[100][4];   //[RecoTrackN]
   Float_t         RecoTrackPrimaryParticleTruePositionTrackStart[100][4];   //[RecoTrackN]
   Float_t         RecoTrackPrimaryParticleTrueMomentumTrackEnd[100][4];   //[RecoTrackN]
   Float_t         RecoTrackPrimaryParticleTruePositionTrackEnd[100][4];   //[RecoTrackN]
   Int_t           RecoTrackNHits[100];   //[RecoTrackN]
   Float_t         RecoTrackTrueHitPosition[100][200][4];   //[RecoTrackN]
   Float_t         RecoTrackPrimaryParticleTrueTrackLengthAsMeasured[100];   //[RecoTrackN]
   Float_t         RecoTrackPrimaryParticleTrueTrackLengthAsMeasuredIgnoreY[100];   //[RecoTrackN]
   Float_t         RecoTrackPrimaryParticleTrueTrackLengthRecoStart[100];   //[RecoTrackN]
   Float_t         RecoTrackPrimaryParticleTrueTrackLengthRecoStartIgnoreY[100];   //[RecoTrackN]
   Float_t         RecoTrackPrimaryParticleTrueTrackLengthInTMSIgnoreY[100];   //[RecoTrackN]
   Int_t           RecoTrackPrimaryParticlePDG[100];   //[RecoTrackN]
   Bool_t          RecoTrackPrimaryParticleIsPrimary[100];   //[RecoTrackN]
   Float_t         RecoTrackPrimaryParticleTrueMomentum[100][4];   //[RecoTrackN]
   Float_t         RecoTrackPrimaryParticleTruePositionStart[100][4];   //[RecoTrackN]
   Float_t         RecoTrackPrimaryParticleTruePositionEnd[100][4];   //[RecoTrackN]
   Float_t         RecoTrackPrimaryParticleTrueTrackLength[100];   //[RecoTrackN]
   Float_t         RecoTrackPrimaryParticleTrueTrackLengthIgnoreY[100];   //[RecoTrackN]
   Float_t         RecoTrackPrimaryParticleTrueTrackLengthInTMS[100];   //[RecoTrackN]
   Float_t         RecoTrackPrimaryParticleTruePositionEnteringTMS[100][4];   //[RecoTrackN]
   Float_t         RecoTrackPrimaryParticleTrueMomentumEnteringTMS[100][4];   //[RecoTrackN]
   Float_t         RecoTrackPrimaryParticleTrueMomentumLeavingTMS[100][4];   //[RecoTrackN]
   Bool_t          RecoTrackPrimaryParticleTMSFiducialStart[100];   //[RecoTrackN]
   Bool_t          RecoTrackPrimaryParticleTMSFiducialTouch[100];   //[RecoTrackN]
   Bool_t          RecoTrackPrimaryParticleTMSFiducialEnd[100];   //[RecoTrackN]
   Bool_t          RecoTrackPrimaryParticleLArFiducialStart[100];   //[RecoTrackN]
   Bool_t          RecoTrackPrimaryParticleLArFiducialTouch[100];   //[RecoTrackN]
   Bool_t          RecoTrackPrimaryParticleLArFiducialEnd[100];   //[RecoTrackN]
   Int_t           RecoTrackSecondaryParticlePDG[100];   //[RecoTrackN]
   Bool_t          RecoTrackSecondaryParticleIsPrimary[100];   //[RecoTrackN]
   Float_t         RecoTrackSecondaryParticleTrueMomentum[100][4];   //[RecoTrackN]
   Float_t         RecoTrackSecondaryParticleTruePositionStart[100][4];   //[RecoTrackN]
   Float_t         RecoTrackSecondaryParticleTruePositionEnd[100][4];   //[RecoTrackN]
