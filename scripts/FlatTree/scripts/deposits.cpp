...
void deposits(std::string filename) {
  ...
  tree->SetBranchStatus("deposit", true);
  tree->SetBranchAddress("deposit", &deposits);
  ...
  canvname.ReplaceAll(".root", "_DepEnergy_Distance");
